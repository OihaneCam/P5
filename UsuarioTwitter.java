...
public class UsuarioTwitter implements Comparable<UsuarioTwitter>{
	...
	public int getFriendsEnSistema() {
		return friendsEnSistema;
	}
	public void setFriendsEnSistema(int amigosEnSistema) {
		this.friendsEnSistema = amigosEnSistema;
	}
	//Constructor
	...
	public int compareTo(UsuarioTwitter o) {
		int comp = o.friendsEnSistema - friendsEnSistema;
		if(comp != 0) {
			return comp;
		}
